...
def tokenize(belief: Belief, state: State, emission: Emission, next_belief: Belief, next_state: State) -> tuple[int, int, int, int, int]:
    return (
        belief2idx[belief],
        state2idx[state],
        int(emission),
...
def detokenize(belief: int, state: int, emission: int, next_belief: int, next_state: int) -> tuple[Belief, State, Emission, Belief, State]:
    return (
        idx2belief[belief],
        idx2state[state],
